...
| `src/browser-manager.js` | Browser lifecycle | Starts/stops broker-owned Chrome instances, builds launch options, and tracks instance metadata. |
...
| `src/server.js` | Control and CDP proxy server | Serves lifecycle control routes, proxies HTTP discovery, and tunnels WebSocket upgrades to Chrome instances. |
